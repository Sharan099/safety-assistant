...
| Prior rebuild ledger | `docs/rebuild/v1-ledger.md` (v1 rebuild M0–M17, measured results) — historical; superseded by this directory |
...
| Docker build + smoke | executed at 0c7afd1 (see docs/rebuild/v1-ledger.md §9); not re-run this phase |
