...
12. 
Names and addresses of Technical Services responsible for conducting approval test, and  
...
(b) 
Document risks assessment (conducted during development phase or 
...
7.2.2.2. 
The vehicle manufacturer shall demonstrate that the processes used within 
...
Within these processes, the threats in Annex 5, Part A, and other 
relevant threats shall be considered; 
(c) 
The processes used for the assessment, categorization and treatment of 
the risks identified; 
(d) 
The processes in place to verify that the risks identified are 
...
(g) 
The processes used to monitor for, detect and respond to cyber-attacks, 
cyber threats and vulnerabilities on vehicle types and the processes used 
to assess whether the cyber security measures implemented are still 
effective in the light of new cyber threats and vulnerabilities that have 
been identified. 
(h) 
The processes used to provide relevant data to support analysis of 
...
(b)  
Include the capability to analyse and detect cyber threats, vulnerabilities 
and cyber-attacks from vehicle data and vehicle logs. This capability 
shall respect paragraph 1.3. and the privacy rights of car owners or 
drivers, particularly with respect to consent. 
7.2.2.5. 
The vehicle manufacturer shall be required to demonstrate how their Cyber 
...
7.3.1. 
The manufacturer shall have a valid Certificate of Compliance for the Cyber 
Security Management System relevant to the vehicle type being approved. 
However, for type approvals prior to 1 July 2024, if the vehicle manufacturer 
can demonstrate that the vehicle type could not be developed in compliance 
with the CSMS, then the vehicle manufacturer shall demonstrate that cyber 
security was adequately considered during the development phase of the 
...
relevant risk. 
7.3.4. 
The vehicle manufacturer shall protect the vehicle type against risks identified 
...
In particular, for type approvals prior to 1 July 2024, the vehicle manufacturer 
shall ensure that another appropriate mitigation is implemented if a mitigation 
measure referred to in Annex 5, Part B or C is technically not feasible. The 
respective assessment of the technical feasibility shall be provided by the 
...
data. 
7.3.6. 
The vehicle manufacturer shall perform, prior to type approval, appropriate 
...
(b) 
Support the monitoring capability of the vehicle manufacturer with 
regards to detecting threats, vulnerabilities and cyber-attacks relevant 
to the vehicle type; 
(c) 
Provide data forensic capability to enable analysis of attempted or 
successful cyber-attacks. 
7.3.8. 
Cryptographic modules used for the purpose of this Regulation shall be in line 
...
7.4.1. 
The vehicle manufacturer shall report at least once a year, or more frequently 
...
7.4.2 
The Approval Authority or the Technical Service shall verify the provided 
...
shall be notified to the approval authority which approved the vehicle type.  
...
require, where relevant, a further test report from the Technical Service 
...
(a) 
The vehicle systems which are relevant to the cyber security of the vehicle 
type; 
(b) 
The components of those systems that are relevant to cyber security; 
(c) 
The interactions of those systems with other systems within the vehicle type 
...
9.7.  
Documents for the vehicle type to be approved describing what tests have been used 
...
concerned has been approved in the Netherlands (E 4), pursuant to Regulation No. 155, and 
...
2. 
Part A, Part B, and Part C shall be considered for risk assessment and mitigations to 
be implemented by vehicle manufacturers.  
3. 
The high-level vulnerability and its corresponding examples have been indexed in Part 
...
1.2 
Unauthorized internet access to the server (enabled 
...
media connecting to the server) 
3.5 
Information breach by unintended sharing of data 
(e.g. admin errors) 
4.3.2 Threats to 
vehicles regarding 
their communication 
...
4.1 
Spoofing of messages by impersonation (e.g. 
802.11p V2X during platooning, GNSS messages, 
etc.) 
4.2 
Sybil attack (in order to spoof other vehicles as if 
...
code/data 
5.1 
Communications channels permit code injection, for 
example tampered software binary might be injected 
into the communication stream 
5.2 
Communications channels permit manipulate of 
vehicle held data/code 
5.3 
Communications channels permit overwrite of 
vehicle held data/code 
5.4 
Communications channels permit erasure of vehicle 
held data/code 
5.5 
Communications channels permit introduction of 
...
6.1 
Accepting information from an unreliable or 
untrusted source 
6.2 
...
6.3 
Replay attack, for example an attack against a 
...
8.2 
Black hole attack, in order to disrupt 
...
vehicle systems 
9.1 
An unprivileged user is able to gain privileged 
...
10.1 
Virus embedded in communication media infects 
vehicle systems 
11 
...
11.2 
Malicious V2X messages, e.g. infrastructure to 
...
update procedures 
12.1 
Compromise of over the air software update 
procedures.  This includes fabricating the system 
update program or firmware 
12.2 
Compromise of local/physical software update 
procedures. This includes fabricating the system 
update program or firmware 
12.3 
The software is manipulated before the update 
...
13 
It is possible to deny legitimate 
updates 
13.1 
Denial of Service attack against update server or 
...
communications 
16.1 
Manipulation of functions designed to remotely 
operate systems, such as remote key, immobilizer, 
and charging pile 
16.2 
Manipulation of vehicle telematics (e.g. 
manipulate temperature measurement of sensitive 
goods, remotely unlock cargo doors) 
16.3 
Interference with short range wireless systems or 
sensors 
17 
...
data/code 
20.1 
Illegal/unauthorized changes to vehicle’s electronic 
ID 
20.2 
Identity fraud. For example, if a user wants to 
...
20.4 
Data manipulation to falsify vehicle’s driving data 
...
21.1 
Unauthorized deletion/manipulation of system event 
logs 
22 
Introduction of malware 
22.2 
Introduce malicious software or malicious software 
activity 
23 
Introduction of new software or 
overwrite existing software 
23.1 
Fabrication of software of the vehicle control 
...
operations 
24.1 
Denial of service, for example this may be triggered 
...
parameters 
25.1 
Unauthorized access of falsify the configuration 
parameters of vehicle’s key functions, such as 
brake data, airbag deployed threshold, etc. 
25.2 
Unauthorized access of falsify the charging 
...
26.1 
Combination of short encryption keys and long 
period of validity enables attacker to break 
encryption 
26.2 
Insufficient use of cryptographic algorithms to 
protect sensitive systems 
26.3 
Using already or soon to be deprecated 
...
27.1 
Hardware or software, engineered to enable an 
...
vulnerabilities 
28.1 
Software bugs. The presence of software bugs can 
...
privileges 
29 
Network design introduces 
vulnerabilities 
29.1 
Superfluous internet ports left open, providing 
access to network systems 
29.2 
Circumvent network separation to gain control. 
...
Unintended transfer of data can   
 occur 
31.1 
Information breach. Personal data may be leaked 
...
32.1 
Manipulation of electronic hardware, e.g. 
...
Mitigation 
4.1 
Spoofing of messages (e.g. 802.11p 
...
4.2 
Sybil attack (in order to spoof other 
vehicles as if there are many vehicles on 
the road) 
M11 
Security controls shall be implemented for 
storing cryptographic keys (e.g., use of Hardware 
Security Modules) 
5.1 
Communication channels permit code 
...
integrity of messages it receives 
6.2 
Man in the middle attack / session 
hijacking 
M10 
The vehicle shall verify the authenticity and 
integrity of messages it receives 
6.3 
Replay attack, for example an attack 
against a communication gateway 
allows the attacker to downgrade 
software of an ECU or firmware of the 
gateway 
7.1 
Interception of information / interfering 
radiations / monitoring communications 
M12 
Confidential data transmitted to or from the 
vehicle shall be protected 
7.2 
Gaining unauthorized access to files or 
data 
M8 
Through system design and access control it 
should not be possible for unauthorized personnel 
to access personal or system critical data. 
Example of Security Controls can be found in 
OWASP 
8.1 
Sending a large number of garbage data 
to vehicle information system, so that it 
is unable to provide services in the 
normal manner 
M13 
Measures to detect and recover from a denial of 
...
service attack shall be employed 
9.1 
An unprivileged user is able to gain 
privileged access, for example root 
access 
M9 
Measures to prevent and detect unauthorized 
access shall be employed 
10.1 
Virus embedded in communication 
media infects vehicle systems 
M14 
Measures to protect systems against embedded 
viruses/malware should be considered 
11.1 
Malicious internal (e.g. CAN) messages 
M15 
Measures to detect malicious internal messages or 
...
Malicious diagnostic messages 
11.4 
Malicious proprietary messages (e.g. 
...
enable an attack 
M18 
Measures shall be implemented for defining and 
controlling user roles and access privileges, 
based on the principle of least access privilege 
15.2 
Defined security procedures are not 
followed 
M19 
Organizations shall ensure security procedures 
...
Mitigation 
16.1 
Manipulation of functions designed to 
...
doors) 
16.3 
Interference with short range wireless 
systems or sensors 
17.1 
Corrupted applications, or those with poor 
...
vehicle 
18.1 
External interfaces such as USB or other 
ports used as a point of attack, for example 
through code injection 
M22 
Security controls shall be applied to external 
interfaces 
18.2 
Media infected with viruses connected to 
the vehicle  
18.3 
Diagnostic access (e.g.  dongles in OBD 
...
Mitigation 
19.1 
Extraction of copyright or proprietary 
...
Modules 
20.1 
Illegal/unauthorised changes to vehicle’s 
electronic ID 
M7 
Access control techniques and designs shall be 
applied to protect system data/code.  Example 
Security Controls can be found in OWASP 
20.2 
Identity fraud. For example, if a user wants 
...
information 
20.4 
Data manipulation to falsify vehicle’s 
driving data (e.g. mileage, driving speed, 
driving directions, etc.) 
20.5 
Unauthorised changes to system diagnostic 
data 
21.1 
...
Security Controls can be found in OWASP. 
23.1 
Fabrication of software of the vehicle 
...
Security Controls can be found in OWASP 
25.2 
Unauthorized access to falsify charging 
...
6. 
Mitigations for "Potential vulnerabilities that could be exploited if not sufficiently 
...
Mitigation 
26.1 
Combination of short encryption keys and 
...
26.2 
Insufficient use of cryptographic algorithms 
to protect sensitive systems 
26.3 
Using deprecated cryptographic algorithms  
27.1 
Hardware or software, engineered to enable 
...
hardware development shall be followed 
28.1 
The presence of software bugs can be a basis 
...
29.1 
Superfluous internet ports left open, 
providing access to network systems 
29.2 
Circumvent network separation to gain 
...
Mitigation 
31.1 
Information breach. Personal data may be breached 
when the car changes user (e.g. is sold or is used as 
hire vehicle with new hirers) 
M24 
...
Mitigation 
32.1 
Manipulation of OEM hardware, e.g. 
...
Mitigation 
1.1 & 3.1 
Abuse of privileges by staff (insider 
attack) 
M1 
Security Controls are applied to back-end systems to 
minimise the risk of insider attack 
1.2 & 3.3 
Unauthorised internet access to the 
...
Mitigation 
30.1 
Damage caused by a third party. Sensitive data may 
...
30.2 
Loss from DRM (digital right management) 
conflicts. User data may be deleted due to DRM 
issues 
30.3 
The (integrity of) sensitive data may be lost due to 
